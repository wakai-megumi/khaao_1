// frontend/src/pages/auth/PartnerLogin.jsx
...
const PartnerLogin = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      console.error("❌ Partner login error:", err.response.data.message);
        ...
        <div className="bg-white dark:bg-gray-800 rounded-lg shadow-md overflow-hidden">
          ...
          <div className="bg-gray-50 dark:bg-gray-700 px-8 py-4 border-t border-gray-200 dark:border-gray-600 text-center">
            <p className="text-sm text-gray-600 dark:text-gray-300">
              ...
              <Link to="/foodpartner/register" className="font-medium text-blue-600 hover:text-blue-500 dark:text-blue-400 dark:hover:text-blue-300">
                Register as Partner
              </Link>
            </p>
